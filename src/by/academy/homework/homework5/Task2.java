...
public class Task2 {
    public static void main(String[] args) {
        try (FileInputStream input =
                     new FileInputStream("./src/by/academy/homework/homework5/homework5_io/Task2.txt");
             FileOutputStream output =
                     new FileOutputStream("./src/by/academy/homework/homework5/homework5_io/Task2_result.txt")) {
